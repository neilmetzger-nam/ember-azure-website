  ...
  return (
    <footer className="border-t border-white/10 bg-charcoal">
      <div className="mx-auto max-w-7xl px-6 py-16">
        <div className="grid gap-12 md:grid-cols-4">
          ...
          <div className="md:col-span-1">
            ...
            <p className="mt-1 text-sm font-medium text-gold">
              Opening 2026 — Village at Leesburg
            </p>
          </div>

          {/* Navigation */}
          <div>
            <h4 className="mb-4 text-xs font-semibold uppercase tracking-widest text-warm-white/40">
              Navigate
            </h4>
            <div className="flex flex-col gap-2">
              {[
                ...
                <Link
                  key={link.href}
                  href={link.href}
                  className="text-sm text-warm-white/60 transition-colors hover:text-ember"
                >
                  {link.label}
                </Link>
              ))}
          ...
          <div>
            ...
            <div className="flex gap-4">
              ...
              <a
                ...
                className="text-warm-white/60 transition-colors hover:text-ember"
              >
        ...
        <div className="mt-12 border-t border-white/5 pt-6 text-center text-xs text-warm-white/30">
          &copy; {new Date().getFullYear()} Ember &amp; Azure. All rights reserved.
        </div>
      </div>
    </footer>
  );
